...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'student.verified' => \Vanguard\Http\Middleware\StudentVerify::class,
        'student.verified.check' => \Vanguard\Http\Middleware\StudentVerifiedCheck::class,
        ...
        'prevent-back-history' => \Vanguard\Http\Middleware\PreventBackHistory::class,
    ];
