                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        <input type="text" name="first_name" id="first_name"
                                            class="form-control input-solid" value="{{$user->first_name}}" placeholder="@lang('FirstName')">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        <input type="text" name="last_name" id="last_name"
                                            class="form-control input-solid" value="{{$user->last_name}}" placeholder="@lang('LastName')">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        <input type="email" name="email" id="email" class="form-control input-solid"
                                        value="{{$user->email}}" placeholder="@lang('Email')">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        <input type="phone" name="phone" id="phone" class="form-control input-solid"
                                        value="{{$user->phone}}" placeholder="@lang('Phone')">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        <input type="date" name="birthday" id="birthday"
                                            class="form-control input-solid" value="{{ Carbon\Carbon::parse($user->birthday)->format('Y-m-d') }}" placeholder="@lang('Date of Birth')">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        <textarea name="address" id="address" class="form-control input-solid"
                                            value="{{ $user->address }}" placeholder="@lang('Address')" rows="1">{{ $user->address }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        <input type="text" name="pin_code" id="pin_code"
                                            class="form-control input-solid"  value="{{ $user->pin_code }}" placeholder="@lang('Pin Code')">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <select name="centers" id="centers" class="form-control input-solid">
                                        ...
                                        <option value="{{$center->id}}" {{$center->id == $userDetails->center_id  ? 'selected' : ''}}>{{$center->center_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-4">
                                    <select name="courses" id="courses" class="form-control input-solid">
                                        ...
                                        <option value="{{$course->id}}" {{$course->id == $userDetails->course_id  ? 'selected' : ''}}>{{$course->course_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <!-- <div class="col-md-4">
                                    <select name="feePlanType" id="feePlanType" class="form-control input-solid">
                                        <option>Select Fee Plan Type</option>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td><select id='paymentType' name="paymentType" class='form-control'>
                                                    ...
                                                    <option value='lumpsum'  {{ "lumpsum" == $userDetails->selected_fee_type  ? 'selected' : ''}}>Lumpsum</option>
                                                    <option value='installment' {{ "installment" == $userDetails->selected_fee_type  ? 'selected' : ''}}>Installment</option>
                                                </select></td>
                                        </tr>
                                    </table>
