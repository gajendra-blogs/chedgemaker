            ...
            <div class="card-body">
                {!! Form::open(['route' => 'settings.notifications.update', 'id' => 'notification-settings-form']) !!}
                    ...
                    <div class="form-group">
                        <div class="">
                            <div class="">
                                <label for="notify_due_date">@lang('Notify Installments Due')</label>
                                <input type="text" value="{{ setting('notify_due_date') }}" name="notify_due_date" id="notify_due_date" class="form-control" />
                            </div>
                            <div class="mt-3 d-flex flex-column">
                                <label class="mb-0">@lang('Notify Installments Due')</label>

                                <small class="pt-0 text-muted">
                                    @lang('Number of days define due days for installments.')
                                </small>
                            </div>
                        </div>
                    </div>
