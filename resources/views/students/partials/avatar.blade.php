    ...
    <div class="text-center">
        <div class="avatar-preview">
            <img class="avatar rounded-circle img-thumbnail img-responsive mt-5 mb-4"
                 width="150"
                 src="{{ $edit ? $student->present()->avatar : url('assets/img/profile.png') }}">

            <h5 class="text-muted">{{ $student->present()->nameOrEmail }}</h5>
        </div>
                ...
                <div class="row">
                    ...
                    @if ($edit)
                        <div class="col-md-4 avatar-source source-external"
                             data-url="{{ $updateUrl }}">
                            <img src="{{ $student->gravatar() }}" class="rounded-circle img-thumbnail img-responsive">
